...
func templatesS3Tf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/s3.tf", size: 905, mode: os.FileMode(420), modTime: time.Unix(1472227085, 0)}
